...
// SVG paths for each icon (from Feather Icons)
const iconPaths: Record<string, string> = {
	Activity: 'M22 12h-4l-3 9L9 3l-3 9H2',
	AlertCircle: 'M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 14a1 1 0 110-2 1 1 0 010 2zm1-4h-2V7h2v5z',
	...
	Clock: 'M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8zm1-13h-2v6h6v-2h-4V7z',
